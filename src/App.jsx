...
function App() {
  ...
  return (
    <div className="flex h-screen bg-gray-100 overflow-hidden">
      ...
      <button 
        className="md:hidden fixed top-4 left-4 z-20 p-2 bg-gray-800 text-white rounded-md shadow-lg"
      ...
      <div 
        className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} 
                    ...
                    md:w-1/4 w-64 fixed md:static top-0 left-0 h-full bg-gray-800 text-white flex flex-col z-10`}
      >
        <div className="p-4 border-b border-gray-700 flex justify-between items-center">
          <h1 className="text-xl font-semibold">Venice Chats</h1>
          <button 
            onClick={() => {
              createNewChat();
